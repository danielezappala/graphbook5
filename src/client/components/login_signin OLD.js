        ...
        <div className={classes.paper}>
          ...
          <form onSubmit={onSubmit} className={classes.form} noValidate>
            <TextField
              ...
              autoFocus
              type="text" 
               onChange={(event) => globalDispatch({type: "SETUSEREMAIL", payload:event.target.value})}     
            />
            <TextField
              variant="outlined"
              margin="normal"
              ...
              type="password" 
               onChange={(event) => globalDispatch({type: "SETUSERPASSWORD", payload:event.target.value})}     
